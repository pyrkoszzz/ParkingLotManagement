    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PricingPlanTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscribers", x => x.IdCardNumber);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricingPlanTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "ParkingSpots",
                columns: new[] { "Id", "TotalSpots" },
                values: new object[] { 1, 500 });

            migrationBuilder.InsertData(
                table: "PricingPlanTypes",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "weekday" });

            migrationBuilder.InsertData(
                table: "PricingPlanTypes",
                columns: new[] { "Id", "Name" },
                values: new object[] { 2, "weekend" });
